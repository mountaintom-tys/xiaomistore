	...
	<!-- start header -->
		<header>
			<div class="top center">
				<div class="left fl">
					<ul>
						<li><a href="xiaomishangcheng.action" target="_blank">小米商城（作者：唐意山）</a></li>
						<li>|</li>
						<li><a href="">MIUI</a></li>
						<li>|</li>
						<li><a href="">米聊</a></li>
				...
				<div class="right fr">
					...
					<div class="fr">
						<ul>
							...
							<li>${line }</li>
							<li><a href="${href1}" target="_blank">${status1}</a></li>
							<li>${line }</li>
							<li><a href="#">消息通知</a></li>
						</ul>
					</div>
...
<!-- start banner_x -->
		<div class="banner_x center">
			...
			<div class="nav fl">
				<ul>
					<li><a href="liebiao.action" target="_blank">小米手机</a></li>
					<li><a href="">红米</a></li>
						...
						<div class="pop">
							<div class="left fl">
								<div>
									...
									<div class="xuangou_right fr"><a href="xiangqing.action" target="_blank">选购</a></div>
									<div class="clear"></div>
								</div>
								<div>
									<div class="xuangou_left fl">
